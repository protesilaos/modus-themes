...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(diff-nonexistent ((t (:inherit (modus-theme-subtle-neutral)))))
   ...
   `(flycheck-error-list-id-with-explainer ((t (:box (:line-width 1 :color foreground-color) :inherit (flycheck-error-list-id)))))
   ...
   `(flycheck-verify-select-checker ((t (:box (:line-width 1 :color nil :style released-button)))))
   ...
   `(show-paren-match-expression ((t (:inherit (modus-theme-special-mild)))))
