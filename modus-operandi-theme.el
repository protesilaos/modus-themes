...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(diff-function ((,class (:background ,bg-special-warm :foreground ,fg-special-warm :weight normal))))
   `(diff-header ((,class (:background ,bg-special-cold :foreground ,fg-special-cold :weight normal))))
   ...
   `(magit-diff-context ((,class (:background ,bg-dim :foreground ,fg-alt))))
   ...
   `(magit-diff-hunk-heading ((,class (:background ,bg-special-warm :foreground ,fg-special-warm))))
