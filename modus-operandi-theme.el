...
(let ((class '((class color) (min-colors 89)))
	  ...
	  (yellow-subtle-bg "#f0e0a0") (blue-subtle-bg "#b5d4ff")
	  ...
	  (red-intense-bg "#ffa28a") (green-intense-bg "#72da86")
	  (yellow-intense-bg "#f5f77c") (blue-intense-bg "#a0c5ff")
	  (magenta-intense-bg "#e5c0ff") (cyan-intense-bg "#a5f8f2"))
  (custom-theme-set-faces
   ...
   `(mu4e-contact-face ((,class (:foreground ,cyan-alt))))
   `(mu4e-context-face ((,class (:foreground ,magenta-alt :weight bold))))
   ...
   `(mu4e-modeline-face ((t (:inherit (modus-theme-intense-bg-green)))))
   ...
   `(mu4e-system-face ((,class (:foreground ,fg-alt :background ,bg-alt))))
