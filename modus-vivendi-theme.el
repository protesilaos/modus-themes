...
;;;;; basic and/or ungrouped styles
   ...
   `(help-argument-name ((,class :foreground ,cyan ,@(modus-vivendi-theme-slant))))
...
;;;;; auctex and Tex
   ...
   `(font-latex-doctex-documentation-face ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
   ...
   `(font-latex-sectioning-0-face ((,class :inherit ,@(modus-vivendi-theme-variable-pitch) :foreground ,blue-nuanced)))
   `(font-latex-sectioning-1-face ((,class :inherit (bold ,@(modus-vivendi-theme-variable-pitch)) :foreground ,blue-nuanced)))
   `(font-latex-sectioning-2-face ((,class :inherit (bold ,@(modus-vivendi-theme-variable-pitch)) :foreground ,blue-nuanced)))
   `(font-latex-sectioning-3-face ((,class :inherit (bold ,@(modus-vivendi-theme-variable-pitch)) :foreground ,blue-nuanced)))
   `(font-latex-sectioning-4-face ((,class :inherit (bold ,@(modus-vivendi-theme-variable-pitch)) :foreground ,blue-nuanced)))
   `(font-latex-sectioning-5-face ((,class :inherit ,@(modus-vivendi-theme-variable-pitch) :foreground ,blue-nuanced)))
   `(font-latex-sedate-face ((,class ,@(modus-vivendi-theme-bold-weight) :foreground ,magenta-alt-other)))
   `(font-latex-slide-title-face ((,class :inherit (bold ,@(modus-vivendi-theme-variable-pitch)) :foreground ,cyan-nuanced
                                          ,@(modus-vivendi-theme-scale modus-vivendi-theme-scale-4))))
...
;;;;; calfw
   ...
   `(cfw:face-title ((,class :inherit ,@(modus-vivendi-theme-variable-pitch)
...
;;;;; company-mode
   ...
   `(company-tooltip-annotation ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
...
;;;;; completions
   `(completions-annotations ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
...
;;;;; counsel
   ...
   `(counsel-variable-documentation ((,class :foreground ,yellow-alt-other ,@(modus-vivendi-theme-slant))))
;;;;; counsel-css
...
;;;;; cperl-mode
   ...
   `(cperl-hash-face ((,class :inherit bold :background ,bg-alt :foreground ,red-alt ,@(modus-vivendi-theme-slant))))
;;;;; csv-mode
...
;;;;; deft
   ...
   `(deft-summary-face ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
...
;;;;; dictionary
   ...
   `(dictionary-word-entry-face ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
;;;;; diff-hl
...
;;;;; dim-autoload
   `(dim-autoload-cookie-line ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
;;;;; dir-treeview
...
;;;;; eshell-prompt-extras (epe)
   ...
   `(epe-remote-face ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
   `(epe-status-face ((,class :foreground ,magenta-alt-other)))
   `(epe-venv-face ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
;;;;; eshell-syntax-highlighting
...
;;;;; evil-goggles
   ...
   `(evil-goggles-commentary-face ((,class :inherit modus-theme-subtle-neutral ,@(modus-vivendi-theme-slant))))
...
;;;;; flycheck-indicator
   `(flycheck-indicator-disabled ((,class :foreground ,fg-inactive ,@(modus-vivendi-theme-slant))))
...
;;;;; flycheck-posframe
   ...
   `(flycheck-posframe-face ((,class :foreground ,fg-main ,@(modus-vivendi-theme-slant))))
...
;;;;; forge
   ...
   `(forge-topic-unmerged ((,class :foreground ,magenta ,@(modus-vivendi-theme-slant))))
   `(forge-topic-unread ((,class :inherit bold :foreground ,fg-main)))
;;;;; fountain-mode
   `(fountain-character ((,class :foreground ,blue-alt-other)))
   `(fountain-comment ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
   ...
   `(fountain-note ((,class :foreground ,yellow ,@(modus-vivendi-theme-slant))))
...
;;;;; git-rebase
   `(git-rebase-comment-hash ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
   `(git-rebase-comment-heading ((,class :inherit bold :foreground ,fg-dim ,@(modus-vivendi-theme-slant))))
...
;;;;; hl-todo
   `(hl-todo ((,class :inherit bold :foreground ,red-alt-other ,@(modus-vivendi-theme-slant))))
;;;;; hydra
...
;;;;; indium
   ...
   `(indium-litable-face ((,class :foreground ,fg-special-warm ,@(modus-vivendi-theme-slant))))
...
;;;;; ivy
   ...
   `(ivy-completions-annotations ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
   ...
   `(ivy-minibuffer-match-highlight ((,class ,@(modus-vivendi-theme-extra-completions
                                                ...
                                                blue-alt-other
                                                'bold))))
   `(ivy-modified-buffer ((,class :foreground ,yellow ,@(modus-vivendi-theme-slant))))
   `(ivy-modified-outside-buffer ((,class :foreground ,yellow-alt ,@(modus-vivendi-theme-slant))))
...
;;;;; lsp-mode
   ...
   `(lsp-face-semhl-field-static ((,class :foreground ,cyan-alt ,@(modus-vivendi-theme-slant))))
   ...
   `(lsp-face-semhl-static-method ((,class :foreground ,magenta ,@(modus-vivendi-theme-slant))))
   `(lsp-face-semhl-type-class ((,class :foreground ,magenta-alt)))
   `(lsp-face-semhl-type-enum ((,class :foreground ,magenta-alt)))
   `(lsp-face-semhl-type-primitive ((,class :foreground ,magenta-alt ,@(modus-vivendi-theme-slant))))
   `(lsp-face-semhl-type-template ((,class :foreground ,magenta-alt ,@(modus-vivendi-theme-slant))))
   `(lsp-face-semhl-type-typedef ((,class :foreground ,magenta-alt ,@(modus-vivendi-theme-slant))))
...
;;;;; markdown-mode
   ...
   `(markdown-link-title-face ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
...
;;;;; mu4e
   ...
   `(mu4e-footer-face ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
   ...
   `(mu4e-moved-face ((,class :foreground ,yellow ,@(modus-vivendi-theme-slant))))
   ...
   `(mu4e-system-face ((,class :foreground ,fg-mark-del ,@(modus-vivendi-theme-slant))))
...
;;;;; nxml-mode
   ...
   `(nxml-char-ref-number ((,class ,@(modus-vivendi-theme-syntax-foreground
                                      green-alt-other green-alt-other-faint)
                                   ,@(modus-vivendi-theme-bold-weight))))
   `(nxml-delimited-data ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
...
;;;;; org
   ...
   `(org-document-info-keyword ((,class ,@(modus-vivendi-theme-mixed-fonts)
                                        :foreground ,fg-alt)))
   `(org-document-title ((,class :inherit (bold ,@(modus-vivendi-theme-variable-pitch)) :foreground ,fg-special-cold
                                 ,@(modus-vivendi-theme-scale modus-vivendi-theme-scale-5))))
   ...
   `(org-headline-done ((,class :inherit ,@(modus-vivendi-theme-variable-pitch) :foreground ,green-nuanced)))
   `(org-headline-todo ((,class :inherit ,@(modus-vivendi-theme-variable-pitch) :foreground ,red-nuanced)))
   ...
   `(org-quote ((,class ,@(modus-vivendi-theme-org-block bg-dim)
                        :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
...
;;;;; org-journal
   `(org-journal-calendar-entry-face ((,class :foreground ,yellow-alt-other ,@(modus-vivendi-theme-slant))))
   `(org-journal-calendar-scheduled-face ((,class :foreground ,red-alt-other ,@(modus-vivendi-theme-slant))))
...
;;;;; paradox
   ...
   `(paradox-comment-face ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
...
;;;;; pomidor
   ...
   `(pomidor-skip-face ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
...
;;;;; racket-mode
   ...
   `(racket-logger-config-face ((,class :foreground ,fg-alt ,@(modus-vivendi-theme-slant))))
   `(racket-logger-debug-face ((,class :foreground ,blue-alt-other)))
   `(racket-logger-info-face ((,class :foreground ,fg-lang-note)))
   `(racket-logger-topic-face ((,class :foreground ,magenta ,@(modus-vivendi-theme-slant))))
...
;;;;; tuareg
   ...
   `(tuareg-opam-pkg-variable-name-face ((,class ,@(modus-vivendi-theme-syntax-foreground
                                                 ...
                                                 ,@(modus-vivendi-theme-slant))))
;;;;; typescript
   `(typescript-jsdoc-tag ((,class :foreground ,fg-special-mild ,@(modus-vivendi-theme-slant))))
   `(typescript-jsdoc-type ((,class :foreground ,fg-special-calm ,@(modus-vivendi-theme-slant))))
   `(typescript-jsdoc-value ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
;;;;; undo-tree
...
;;;;; vc (vc-hooks.el)
   `(vc-conflict-state ((,class :foreground ,red-active ,@(modus-vivendi-theme-slant))))
   ...
   `(vc-missing-state ((,class :foreground ,magenta-active ,@(modus-vivendi-theme-slant))))
   `(vc-needs-update-state ((,class :foreground ,green-active ,@(modus-vivendi-theme-slant))))
...
;;;;; web-mode
   ...
   `(web-mode-doctype-face ((,class :foreground ,fg-special-cold ,@(modus-vivendi-theme-slant))))
