...
(let ((class '((class color) (min-colors 89)))
      ...
      (fg-special-warm "#f9dbd0") (bg-special-warm "#231c15")
      (fg-special-cold "#cce0ff") (bg-special-cold "#141e2b")
      ...
      (red-intense-bg "#a0313a") (green-intense-bg "#006800")
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-added-highlight ((,class (:background ,green-refine-bg :foreground ,fg-main))))
   ...
   `(magit-diff-file-heading ((,class (:background ,bg-special-cold :foreground ,fg-special-cold :weight normal))))
   `(magit-diff-file-heading-highlight ((,class (:background ,bg-active :foreground ,fg-active :weight bold))))
   `(magit-diff-file-heading-selection ((,class (:background ,bg-alt :foreground ,cyan))))
   `(magit-diff-hunk-heading ((,class (:background ,bg-special-warm :foreground ,fg-special-warm :weight normal))))
   `(magit-diff-hunk-heading-highlight ((,class (:background ,bg-active :foreground ,fg-active :weight bold))))
   ...
   `(magit-diff-removed-highlight ((,class (:background ,red-refine-bg :foreground ,fg-main))))
   `(magit-diffstat-added ((,class (:background ,bg-main :foreground ,green-intense))))
   `(magit-diffstat-removed ((,class (:background ,bg-main :foreground ,red-intense))))
   ...
   `(magit-section-heading-selection ((t (:inherit (magit-diff-file-heading-selection)))))
