...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-file-heading ((,class (:background ,bg-special-cold :foreground ,fg-special-cold :weight bold))))
   `(magit-diff-file-heading-highlight ((,class (:background ,bg-active :foreground ,fg-active))))
