...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-hunk-heading ((,class (:foreground ,fg-special-warm :weight bold))))
   `(magit-diff-hunk-heading-highlight ((,class (:inherit modus-theme-special-warm :weight bold :extend nil))))
   `(magit-diff-hunk-heading-selection ((,class (:inherit magit-diff-file-heading-selection))))
   `(magit-diff-hunk-region ((,class (:background ,bg-region :foreground ,fg-main))))
