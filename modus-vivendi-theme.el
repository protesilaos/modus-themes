...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(diff-refine-added ((t (:inherit (modus-theme-intense-bg-green)))))
   `(diff-refine-changed ((t (:inherit (modus-theme-intense-bg-yellow)))))
   `(diff-refine-removed ((t (:inherit (modus-theme-intense-bg-red)))))
