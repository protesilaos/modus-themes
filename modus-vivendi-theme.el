...
(custom-theme-set-faces
 ...
 '(whitespace-tab ((t (:foreground "#656565"))))
 ...
 '(mode-line ((t (:box (:line-width -1 :color nil :style released-button) :foreground "#ffffff" :background "#202020"))))
 ...
 '(mode-line-inactive ((t (:foreground "#a9a9a9" :background "#111111"))))
 ...
 '(ido-subdir ((t (:foreground "#abdd60" :weight bold))))
