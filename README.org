...
themes in [[https://protesilaos.com/code-casts][my Emacs-related screen casts]] (some older videos contain
earlier versions).
...
# ** Package method
#
# The Modus themes are available in MELPA.
#
# You can install the collection with:
#
