...
* Modus themes for GNU Emacs                                            :TOC:
  :PROPERTIES:
...
- [[#customisation-options][Customisation options]]
  - [[#option-for-distinct-org-source-blocks][Option for distinct Org source blocks]]
  - [[#option-for-colourful-rainbow-headings][Option for colourful "rainbow" headings]]
  ...
  - [[#option-for-three-dimensional-focused-mode-line][Option for three-dimensional focused mode line]]
...
- [[#face-coverage][Face coverage]]
  ...
  - [[#note-about-colour-coded-org-source-blocks][Note about colour-coded ORG source blocks]]
  - [[#note-for-helm-users-of-grep-or-grep-like-functions][Note for HELM users of grep or grep-like functions]]
  - [[#note-on-vc-annotate-background-mode][Note on VC-ANNOTATE-BACKGROUND-MODE]]
- [[#contributing][Contributing]]
  - [[#code-contributions-require-copyright-assignment-to-the-fsf][Code contributions require copyright assignment to the FSF]]
- [[#meta][Meta]]
- [[#copying][COPYING]]
...
The table of contents is created with the [[https://github.com/snosov1/toc-org][toc-org package]] by Sergei
Nosov.
