...
;;;;; gnus
    ...
    `(gnus-cite-5 ((,class :foreground ,cyan-alt)))
    `(gnus-cite-6 ((,class :foreground ,yellow-alt)))
    `(gnus-cite-7 ((,class :foreground ,blue)))
...
;;;;; mu4e
    ...
    `(mu4e-cited-6-face ((,class :foreground ,yellow-alt)))
    `(mu4e-cited-7-face ((,class :foreground ,blue)))
