...
;;;;; agda2-mode
    ...
    `(agda2-highlight-catchall-clause-face ((,class :background ,bg-alt)))
    `(agda2-highlight-coinductive-constructor-face ((,class :inherit font-lock-type-face)))
    `(agda2-highlight-coverage-problem-face ((,class :inherit modus-themes-lang-error)))
    `(agda2-highlight-datatype-face ((,class :inherit font-lock-type-face)))
    `(agda2-highlight-deadcode-face ((,class :background ,bg-active)))
    `(agda2-highlight-dotted-face ((,class :inherit font-lock-variable-name-face)))
    `(agda2-highlight-error-face ((,class :inherit modus-themes-lang-error)))
    ...
    `(agda2-highlight-generalizable-variable-face ((,class :inherit font-lock-variable-name-face)))
    `(agda2-highlight-incomplete-pattern-face ((,class :inherit modus-themes-lang-warning)))
    ...
    `(agda2-highlight-macro-face ((,class :inherit font-lock-keyword-face)))
    `(agda2-highlight-module-face ((,class :inherit font-lock-variable-name-face)))
    `(agda2-highlight-number-face ((,class :foreground ,fg-special-warm)))
    `(agda2-highlight-operator-face ((,class :inherit font-lock-variable-name-face)))
    `(agda2-highlight-positivity-problem-face ((,class :inherit modus-themes-lang-warning)))
    `(agda2-highlight-postulate-face ((,class :inherit font-lock-type-face)))
    `(agda2-highlight-pragma-face ((,class :inherit font-lock-preprocessor-face)))
    ...
    `(agda2-highlight-symbol-face ((,class :inherit font-lock-constant-face)))
    `(agda2-highlight-termination-problem-face ((,class :inherit modus-themes-lang-warning)))
    `(agda2-highlight-typechecks-face ((,class :inherit font-lock-warning-face)))
    `(agda2-highlight-unsolved-constraint-face ((,class :inherit modus-themes-lang-warning)))
    `(agda2-highlight-unsolved-meta-face ((,class :inherit modus-themes-lang-warning)))
;;;;; alert
