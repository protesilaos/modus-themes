...
;;;;; debbugs
    ...
    `(debbugs-gnu-handled ((,c :inherit default)))
    ...
    `(debbugs-gnu-pending ((,c :foreground ,fg-alt)))
    `(debbugs-gnu-stale-1 ((,c :foreground ,magenta-cooler)))
    `(debbugs-gnu-stale-2 ((,c :foreground ,magenta-faint)))
    `(debbugs-gnu-stale-3 ((,c :foreground ,magenta)))
    `(debbugs-gnu-stale-4 ((,c :foreground ,magenta-warmer)))
    `(debbugs-gnu-stale-5 ((,c :foreground ,magenta-intense)))
    `(debbugs-gnu-tagged ((,c :inherit modus-themes-bold :foreground ,accent-1)))
