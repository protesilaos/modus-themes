...
;;;;; gnus
    ...
    `(gnus-cite-2 ((,class :foreground ,green-alt)))
    ...
    `(gnus-cite-7 ((,class :foreground ,green-alt-other)))
...
;;;;; messages
    ...
    `(message-cited-text-2 ((,class :foreground ,green-alt)))
...
;;;;; mu4e
    ...
    `(mu4e-cited-2-face ((,class :foreground ,green-alt)))
