...
;;;;; mark indicators
    ...
    `(modus-themes-mark-alt ((,c :inherit bold :background ,bg-mark-alt :foreground ,fg-mark-alt)))
    `(modus-themes-mark-del ((,c :inherit bold :background ,bg-mark-del :foreground ,fg-mark-del)))
    `(modus-themes-mark-sel ((,c :inherit bold
                                     :background ,@(modus-themes--deuteran
                                                    cyan-refine-bg
                                                    bg-mark-sel)
                                     :foreground ,fg-mark-sel)))
    `(modus-themes-mark-symbol ((,c :inherit bold :foreground ,blue-alt)))
;;;;; heading levels
...
;;;;; absolute essentials
    ...
    `(fringe ((,c ,@(modus-themes--fringe bg-main bg-inactive bg-active)
                      :foreground ,fg-main)))
    `(vertical-border ((,c :foreground ,fg-window-divider-inner)))
;;;;; basic and/or ungrouped styles
    `(bold ((,c :weight bold)))
    `(bold-italic ((,c :inherit (bold italic))))
    `(underline ((,c :underline ,fg-alt)))
    `(buffer-menu-buffer ((,c :inherit bold)))
    `(child-frame-border ((,c :background ,fg-window-divider-inner)))
    ...
    `(escape-glyph ((,c :foreground ,fg-escape-char-construct)))
    `(file-name-shadow ((,c :inherit shadow)))
    `(header-line ((,c :inherit modus-themes-ui-variable-pitch
    ...
    `(homoglyph ((,c :foreground ,red-alt-faint)))
    `(ibuffer-locked-buffer ((,c :foreground ,yellow-alt-other-faint)))
    `(icon-button ((,c :inherit modus-themes-box-button)))
    `(italic ((,c :slant italic)))
    `(nobreak-hyphen ((,c :foreground ,fg-escape-char-construct)))
    `(nobreak-space ((,c :foreground ,fg-escape-char-construct :underline t)))
    `(menu ((,c :inverse-video unspecified :inherit modus-themes-intense-neutral)))
    `(minibuffer-prompt ((,c :inherit modus-themes-prompt)))
    `(mm-command-output ((,c :foreground ,red-alt-other)))
...
;;;;; alert
    `(alert-high-face ((,c :inherit bold :foreground ,red-alt)))
...
;;;;; all-the-icons
    `(all-the-icons-blue ((,c :foreground ,blue-alt-other)))
    `(all-the-icons-blue-alt ((,c :foreground ,blue-alt)))
    `(all-the-icons-cyan ((,c :foreground ,cyan-intense)))
    `(all-the-icons-cyan-alt ((,c :foreground ,cyan-alt)))
    ...
    `(all-the-icons-dmaroon ((,c :foreground ,magenta-alt-faint)))
    `(all-the-icons-dorange ((,c :foreground ,red-alt-faint)))
    `(all-the-icons-dpink ((,c :foreground ,magenta-faint)))
    `(all-the-icons-dpurple ((,c :foreground ,magenta-alt-other-faint)))
    `(all-the-icons-dred ((,c :foreground ,red-faint)))
    `(all-the-icons-dsilver ((,c :foreground ,cyan-alt-faint)))
    `(all-the-icons-dyellow ((,c :foreground ,yellow-alt-faint)))
    `(all-the-icons-green ((,c :foreground ,green-intense)))
    `(all-the-icons-lblue ((,c :foreground ,blue-alt-other)))
    `(all-the-icons-lcyan ((,c :foreground ,cyan)))
    `(all-the-icons-lgreen ((,c :foreground ,green-alt-other)))
    `(all-the-icons-lmaroon ((,c :foreground ,magenta-alt)))
    `(all-the-icons-lorange ((,c :foreground ,red-alt)))
    ...
    `(all-the-icons-lyellow ((,c :foreground ,yellow-alt)))
    ...
    `(all-the-icons-purple ((,c :foreground ,magenta-alt-other)))
    `(all-the-icons-purple-alt ((,c :foreground ,purple-intense)))
    `(all-the-icons-red ((,c :foreground ,red-intense)))
    `(all-the-icons-red-alt ((,c :foreground ,red-alt-other)))
...
;;;;; all-the-icons-ibuffer
    ...
    `(all-the-icons-ibuffer-size-face ((,c :foreground ,cyan-alt-other)))
;;;;; annotate
...
;;;;; ansi-color
    ...
    `(ansi-color-bright-blue ((,c :background ,blue-alt :foreground ,blue-alt)))
    `(ansi-color-bright-cyan ((,c :background ,cyan-alt-other :foreground ,cyan-alt-other)))
    `(ansi-color-bright-green ((,c :background ,green-alt-other :foreground ,green-alt-other)))
    `(ansi-color-bright-magenta ((,c :background ,magenta-alt-other :foreground ,magenta-alt-other)))
    `(ansi-color-bright-red ((,c :background ,red-alt :foreground ,red-alt)))
    `(ansi-color-bright-white ((,c :background "white" :foreground "white")))
    `(ansi-color-bright-yellow ((,c :background ,yellow-alt :foreground ,yellow-alt)))
...
;;;;; apropos
    `(apropos-button ((,c :foreground ,magenta-alt-other)))
    `(apropos-function-button ((,c :foreground ,magenta)))
    `(apropos-keybinding ((,c :inherit modus-themes-key-binding)))
    `(apropos-misc-button ((,c :foreground ,green-alt-other)))
    `(apropos-property ((,c :inherit modus-themes-bold :foreground ,magenta-alt)))
    `(apropos-symbol ((,c :inherit modus-themes-pseudo-header)))
    `(apropos-user-option-button ((,c :foreground ,cyan)))
    `(apropos-variable-button ((,c :foreground ,blue-alt)))
;;;;; artbollocks-mode
    `(artbollocks-face ((,c :inherit modus-themes-lang-note)))
    `(artbollocks-lexical-illusions-face ((,c :background ,bg-alt :foreground ,red-alt :underline t)))
...
;;;;; aw (ace-window)
    `(aw-background-face ((,c :foreground ,fg-unfocused)))
...
;;;;; awesome-tray
    `(awesome-tray-module-awesome-tab-face ((,c :inherit bold :foreground ,red-alt-other)))
    `(awesome-tray-module-battery-face ((,c :inherit bold :foreground ,cyan-alt-other)))
    `(awesome-tray-module-buffer-name-face ((,c :inherit bold :foreground ,yellow-alt-other)))
    `(awesome-tray-module-circe-face ((,c :inherit bold :foreground ,blue-alt)))
    `(awesome-tray-module-date-face ((,c :inherit bold :foreground ,fg-dim)))
    `(awesome-tray-module-evil-face ((,c :inherit bold :foreground ,green-alt)))
    `(awesome-tray-module-git-face ((,c :inherit bold :foreground ,magenta)))
    `(awesome-tray-module-last-command-face ((,c :inherit bold :foreground ,blue-alt-other)))
    ...
    `(awesome-tray-module-rvm-face ((,c :inherit bold :foreground ,magenta-alt-other)))
;;;;; bbdb
    `(bbdb-name ((,c :foreground ,magenta-alt-other)))
    `(bbdb-organization ((,c :foreground ,red-alt-other)))
    `(bbdb-field-name ((,c :foreground ,cyan-alt-other)))
;;;;; binder
...
;;;;; bongo
    ...
    `(bongo-marked-track ((,c :foreground ,fg-mark-alt)))
...
;;;;; calendar and diary
    ...
    `(calendar-weekday-header ((,c :foreground ,fg-unfocused)))
    `(calendar-weekend-header ((,c :foreground ,red-faint)))
    `(diary ((,c :background ,blue-nuanced-bg :foreground ,blue-alt-other)))
    `(diary-anniversary ((,c :foreground ,red-alt-other)))
    `(diary-time ((,c :foreground ,cyan)))
    `(holiday ((,c :background ,magenta-nuanced-bg :foreground ,magenta-alt)))
;;;;; calfw
    `(cfw:face-annotation ((,c :foreground ,fg-special-warm)))
    `(cfw:face-day-title ((,c :foreground ,fg-main)))
    `(cfw:face-default-content ((,c :foreground ,green-alt)))
    `(cfw:face-default-day ((,c :inherit (cfw:face-day-title bold))))
    `(cfw:face-disable ((,c :foreground ,fg-unfocused)))
    `(cfw:face-grid ((,c :foreground ,fg-window-divider-outer)))
    `(cfw:face-header ((,c :inherit bold :foreground ,fg-main)))
    `(cfw:face-holiday ((,c :foreground ,magenta-alt-other)))
    `(cfw:face-periods ((,c :foreground ,cyan-alt-other)))
    `(cfw:face-saturday ((,c :inherit bold :foreground ,cyan-alt-other)))
    `(cfw:face-select ((,c :inherit modus-themes-intense-blue)))
    `(cfw:face-sunday ((,c :inherit bold :foreground ,cyan-alt-other)))
    ...
    `(cfw:face-toolbar-button-on ((,c :inherit bold :background ,blue-nuanced-bg
                                          :foreground ,blue-alt)))
;;;;; calibredb
    `(calibredb-archive-face ((,c :foreground ,magenta-alt-faint)))
    ...
    `(calibredb-size-face (( )))
    `(calibredb-tag-face ((,c :foreground ,magenta-alt-faint)))
;;;;; centaur-tabs
    ...
    `(centaur-tabs-selected ((,c :inherit modus-themes-tab-active)))
    `(centaur-tabs-selected-modified ((,c :inherit (italic centaur-tabs-selected))))
    `(centaur-tabs-unselected ((,c :inherit modus-themes-tab-inactive)))
    `(centaur-tabs-unselected-modified ((,c :inherit (italic centaur-tabs-unselected))))
;;;;; cfrs
    `(cfrs-border-color ((,c :background ,fg-window-divider-inner)))
;;;;; change-log and log-view (`vc-print-log' and `vc-print-root-log')
    ...
    `(change-log-email ((,c :foreground ,cyan-alt-other)))
    `(change-log-file ((,c :inherit bold :foreground ,fg-special-cold)))
    `(change-log-function ((,c :foreground ,green-alt-other)))
    `(change-log-list ((,c :foreground ,magenta-alt)))
    `(change-log-name ((,c :foreground ,magenta-alt-other)))
    `(log-edit-header ((,c :foreground ,fg-special-warm)))
    `(log-edit-headers-separator ((,c :height 1 :background ,fg-window-divider-inner :extend t)))
...
;;;;; cider
    ...
    `(cider-debug-prompt-face ((,c :foreground ,magenta-alt :underline t)))
    ...
    `(cider-docview-literal-face ((,c :foreground ,blue-alt)))
    `(cider-docview-strong-face ((,c :inherit bold :foreground ,fg-special-cold)))
    `(cider-docview-table-border-face ((,c :inherit shadow)))
    `(cider-enlightened-face ((,c :box (:line-width -1 :color ,yellow-alt :style nil) :background ,bg-dim)))
    `(cider-enlightened-local-face ((,c :inherit bold :foreground ,yellow-alt-other)))
    ...
    `(cider-stacktrace-error-message-face ((,c :inherit italic :foreground ,red-alt-other)))
    `(cider-stacktrace-face ((,c :foreground ,fg-main)))
    `(cider-stacktrace-filter-active-face ((,c :foreground ,cyan-alt :underline t)))
    `(cider-stacktrace-filter-inactive-face ((,c :foreground ,cyan-alt)))
...
;;;;; circe (and lui)
    ...
    `(circe-server-face ((,c :foreground ,fg-unfocused)))
    `(lui-button-face ((,c :inherit button)))
    `(lui-highlight-face ((,c :foreground ,magenta-alt)))
...
;;;;; color-rg
    `(color-rg-font-lock-column-number ((,c :foreground ,magenta-alt-other)))
...
;;;;; compilation
    ...
    `(compilation-warning ((,c :inherit modus-themes-bold :foreground ,yellow-alt)))
;;;;; completions
...
;;;;; consult
    ...
    `(consult-async-split ((,c :foreground ,magenta-alt)))
    ...
    `(consult-line-number-prefix ((,c :foreground ,fg-unfocused)))
    `(consult-narrow-indicator ((,c :foreground ,magenta-alt)))
...
;;;;; counsel
    `(counsel-active-mode ((,c :foreground ,magenta-alt-other)))
    `(counsel-application-name ((,c :foreground ,red-alt-other)))
    ...
    `(counsel-variable-documentation ((,c :inherit modus-themes-slant :foreground ,yellow-alt-other)))
;;;;; counsel-css
...
;;;;; crontab-mode
    `(crontab-minute ((,c :foreground ,blue-alt)))
    `(crontab-hour ((,c :foreground ,magenta-alt-other)))
    `(crontab-month-day ((,c :foreground ,magenta-alt)))
    `(crontab-month ((,c :foreground ,blue)))
    `(crontab-week-day ((,c :foreground ,cyan)))
    `(crontab-predefined ((,c :foreground ,blue-alt)))
;;;;; css-mode
...
;;;;; custom (M-x customize)
    ...
    `(custom-comment-tag ((,c :background ,bg-alt :foreground ,yellow-alt-other)))
    `(custom-face-tag ((,c :inherit bold :foreground ,blue-intense)))
    `(custom-group-tag ((,c :inherit modus-themes-pseudo-header :foreground ,magenta-alt)))
    ...
    `(custom-set ((,c :foreground ,blue-alt)))
    `(custom-state ((,c :foreground ,red-alt-faint)))
...
;;;;; dap-mode
    ...
    `(dap-ui-locals-variable-leaf-face ((,c :inherit italic :foreground ,cyan-alt-other)))
    `(dap-ui-marker-face ((,c :inherit modus-themes-subtle-blue)))
    `(dap-ui-sessions-stack-frame-face ((,c :inherit bold :foreground ,magenta-alt)))
...
;;;;; debbugs
    ...
    `(debbugs-gnu-stale-3 ((,c :foreground ,yellow-alt)))
    `(debbugs-gnu-stale-4 ((,c :foreground ,yellow-alt-other)))
    `(debbugs-gnu-stale-5 ((,c :foreground ,red-alt)))
    `(debbugs-gnu-tagged ((,c :foreground ,magenta-alt)))
;;;;; deft
...
;;;;; denote
    ...
    `(denote-faces-keywords ((,c :inherit modus-themes-bold :foreground ,magenta-alt)))
;;;;; devdocs
...
;;;;; diff-mode
    ...
    `(diff-context ((,c ,@(unless (eq modus-themes-diffs 'bg-only) (list :foreground fg-unfocused)))))
    ...
    `(diff-index ((,c :inherit bold :foreground ,blue-alt)))
...
;;;;; dir-treeview
    ...
    `(dir-treeview-audio-icon-face ((,c :inherit dir-treeview-default-icon-face :foreground ,magenta-alt)))
    ...
    `(dir-treeview-directory-icon-face ((,c :inherit dir-treeview-default-icon-face :foreground ,blue-alt)))
    `(dir-treeview-executable-face ((,c :foreground ,red-alt)))
    `(dir-treeview-executable-icon-face ((,c :inherit dir-treeview-default-icon-face :foreground ,red-alt-other)))
    `(dir-treeview-image-face ((,c :foreground ,green-alt-other)))
    `(dir-treeview-image-icon-face ((,c :inherit dir-treeview-default-icon-face :foreground ,green-alt)))
    ...
    `(dir-treeview-video-face ((,c :foreground ,magenta-alt-other)))
    `(dir-treeview-video-icon-face ((,c :inherit dir-treeview-default-icon-face :foreground ,magenta-alt-other)))
;;;;; dired
...
;;;;; dired-git
    `(dired-git-branch-else ((,c :inherit bold :foreground ,magenta-alt)))
    `(dired-git-branch-master ((,c :inherit bold :foreground ,magenta-alt-other)))
;;;;; dired-git-info
    `(dgi-commit-message-face ((,c :foreground ,cyan-alt-other)))
;;;;; dired-narrow
...
;;;;; diredfl
    `(diredfl-autofile-name ((,c :inherit modus-themes-special-cold)))
    `(diredfl-compressed-file-name ((,c :foreground ,fg-special-warm)))
    `(diredfl-compressed-file-suffix ((,c :foreground ,red-alt)))
    `(diredfl-date-time ((,c :foreground ,cyan)))
    `(diredfl-deletion ((,c :inherit modus-themes-mark-del)))
    `(diredfl-deletion-file-name ((,c :inherit modus-themes-mark-del)))
    `(diredfl-dir-heading ((,c :inherit modus-themes-pseudo-header)))
    `(diredfl-dir-name ((,c :inherit dired-directory)))
    `(diredfl-dir-priv ((,c :foreground ,blue-alt)))
    `(diredfl-exec-priv ((,c :foreground ,magenta-alt)))
    `(diredfl-executable-tag ((,c :foreground ,magenta-alt)))
    `(diredfl-file-name ((,c :foreground ,fg-main)))
    `(diredfl-file-suffix ((,c :foreground ,magenta-alt-other)))
    ...
    `(diredfl-link-priv ((,c :foreground ,blue-alt-other)))
    `(diredfl-no-priv ((,c :foreground "gray50")))
    `(diredfl-number ((,c :foreground ,cyan-alt-other-faint)))
    `(diredfl-other-priv ((,c :foreground ,yellow)))
    `(diredfl-rare-priv ((,c :foreground ,red)))
    `(diredfl-read-priv ((,c :foreground ,fg-main)))
    `(diredfl-symlink ((,c :inherit dired-symlink)))
    `(diredfl-tagged-autofile-name ((,c :inherit modus-themes-refine-magenta)))
    `(diredfl-write-priv ((,c :foreground ,cyan)))
;;;;; dired+
    `(diredp-autofile-name ((,c :inherit modus-themes-special-cold)))
    `(diredp-compressed-file-name ((,c :foreground ,fg-special-warm)))
    `(diredp-compressed-file-suffix ((,c :foreground ,red-alt)))
    `(diredp-date-time ((,c :foreground ,cyan)))
    `(diredp-deletion ((,c :inherit modus-themes-mark-del)))
    `(diredp-deletion-file-name ((,c :inherit modus-themes-mark-del)))
    `(diredp-dir-heading ((,c :inherit modus-themes-pseudo-header)))
    `(diredp-dir-name ((,c :inherit dired-directory)))
    `(diredp-dir-priv ((,c :foreground ,blue-alt)))
    `(diredp-exec-priv ((,c :foreground ,magenta-alt)))
    `(diredp-executable-tag ((,c :foreground ,magenta-alt)))
    `(diredp-file-name ((,c :foreground ,fg-main)))
    `(diredp-file-suffix ((,c :foreground ,magenta-alt-other)))
    `(diredp-flag-mark ((,c :inherit modus-themes-mark-sel)))
    `(diredp-flag-mark-line ((,c :inherit modus-themes-mark-sel)))
    `(diredp-ignored-file-name ((,c :inherit shadow)))
    `(diredp-link-priv ((,c :foreground ,blue-alt-other)))
    `(diredp-mode-line-flagged ((,c :foreground ,red-active)))
    `(diredp-mode-line-marked ((,c :foreground ,green-active)))
    `(diredp-no-priv ((,c :foreground "gray50")))
    `(diredp-number ((,c :foreground ,cyan-alt-other-faint)))
    `(diredp-omit-file-name ((,c :inherit shadow :strike-through t)))
    `(diredp-other-priv ((,c :foreground ,yellow)))
    `(diredp-rare-priv ((,c :foreground ,red)))
    `(diredp-read-priv ((,c :foreground ,fg-main)))
    `(diredp-symlink ((,c :inherit dired-symlink)))
    `(diredp-tagged-autofile-name ((,c :inherit modus-themes-refine-magenta)))
    `(diredp-write-priv ((,c :foreground ,cyan)))
;;;;; display-fill-column-indicator-mode
    `(fill-column-indicator ((,c :height 1 :background ,bg-region :foreground ,bg-region)))
;;;;; doom-modeline
    `(doom-modeline-bar ((,c :inherit modus-themes-active-blue)))
    `(doom-modeline-bar-inactive ((,c :background ,fg-inactive :foreground ,bg-main)))
    `(doom-modeline-battery-charging ((,c :foreground ,green-active)))
    `(doom-modeline-battery-critical ((,c :inherit bold :foreground ,red-active)))
    `(doom-modeline-battery-error ((,c :inherit bold :box (:line-width -2)
                                           :foreground ,red-active)))
    `(doom-modeline-battery-full ((,c :foreground ,blue-active)))
    `(doom-modeline-battery-normal ((,c :foreground ,fg-active)))
    `(doom-modeline-battery-warning ((,c :inherit bold :foreground ,yellow-active)))
    `(doom-modeline-buffer-file ((,c :inherit bold :foreground ,fg-active)))
    `(doom-modeline-buffer-major-mode ((,c :inherit bold :foreground ,cyan-active)))
    `(doom-modeline-buffer-minor-mode ((,c :foreground ,fg-inactive)))
    `(doom-modeline-buffer-modified ((,c :inherit bold :foreground ,magenta-active)))
    `(doom-modeline-buffer-path ((,c :inherit bold :foreground ,fg-active)))
    `(doom-modeline-debug ((,c :inherit bold :foreground ,yellow-active)))
    `(doom-modeline-debug-visual ((,c :inherit bold :foreground ,red-active)))
    `(doom-modeline-evil-emacs-state ((,c :inherit bold :foreground ,magenta-active)))
    `(doom-modeline-evil-insert-state ((,c :inherit bold :foreground ,green-active)))
    `(doom-modeline-evil-motion-state ((,c :inherit bold :foreground ,fg-inactive)))
    `(doom-modeline-evil-normal-state ((,c :inherit bold :foreground ,fg-active)))
    `(doom-modeline-evil-operator-state ((,c :inherit bold :foreground ,blue-active)))
    `(doom-modeline-evil-replace-state ((,c :inherit bold :foreground ,red-active)))
    `(doom-modeline-evil-visual-state ((,c :inherit bold :foreground ,cyan-active)))
    `(doom-modeline-highlight ((,c :inherit bold :foreground ,blue-active)))
    `(doom-modeline-host ((,c :inherit italic)))
    `(doom-modeline-info ((,c :foreground ,green-active)))
    `(doom-modeline-lsp-error ((,c :inherit bold :foreground ,red-active)))
    `(doom-modeline-lsp-success ((,c :inherit (bold modus-themes-grue-active))))
    `(doom-modeline-lsp-warning ((,c :inherit bold :foreground ,yellow-active)))
    `(doom-modeline-panel ((,c :inherit modus-themes-active-blue)))
    `(doom-modeline-persp-buffer-not-in-persp ((,c :inherit italic :foreground ,yellow-active)))
    `(doom-modeline-persp-name ((,c :foreground ,fg-active)))
    `(doom-modeline-project-dir ((,c :inherit bold :foreground ,blue-active)))
    `(doom-modeline-project-parent-dir ((,c :foreground ,blue-active)))
    `(doom-modeline-project-root-dir ((,c :foreground ,fg-active)))
    `(doom-modeline-unread-number ((,c :inherit italic :foreground ,fg-active)))
    `(doom-modeline-urgent ((,c :inherit bold :foreground ,red-active)))
    `(doom-modeline-warning ((,c :inherit bold :foreground ,yellow-active)))
;;;;; easy-jekyll
    `(easy-jekyll-help-face ((,c :background ,bg-dim :foreground ,blue-alt-other)))
;;;;; ebdb
    `(ebdb-address-default ((,c :foreground ,fg-special-calm)))
    `(ebdb-defunct ((,c :inherit shadow)))
    `(ebdb-field-hidden ((,c :foreground ,magenta)))
    `(ebdb-label ((,c :foreground ,cyan-alt-other)))
    `(ebdb-mail-default ((,c :foreground ,fg-main)))
    `(ebdb-mail-primary ((,c :foreground ,magenta-alt)))
    `(ebdb-marked ((,c :background ,cyan-intense-bg)))
    `(ebdb-organization-name ((,c :foreground ,red-alt-other)))
    `(ebdb-person-name ((,c :foreground ,magenta-alt-other)))
    `(ebdb-phone-default ((,c :foreground ,cyan)))
    `(eieio-custom-slot-tag-face ((,c :foreground ,red-alt)))
;;;;; ediff
...
;;;;; el-search
    `(el-search-highlight-in-prompt-face ((,c :inherit bold :foreground ,magenta-alt)))
...
;;;;; elfeed
    ...
    `(elfeed-search-tag-face ((,c :foreground ,magenta-alt-faint)))
...
;;;;; elfeed-score
    ...
    `(elfeed-score-debug-level-face ((,c :foreground ,magenta-alt-other)))
...
;;;;; ement (ement.el)
    ...
    `(ement-room-mention ((,c :background ,bg-hl-alt-intense)))
...
;;;;; emms
    `(emms-browser-album-face ((,c :foreground ,magenta-alt-other)))
    `(emms-browser-artist-face ((,c :foreground ,cyan)))
    `(emms-browser-composer-face ((,c :foreground ,magenta-alt)))
    `(emms-browser-performer-face ((,c :inherit emms-browser-artist-face)))
    `(emms-browser-track-face ((,c :inherit emms-playlist-track-face)))
    `(emms-browser-year/genre-face ((,c :foreground ,cyan-alt-other)))
    `(emms-playlist-track-face ((,c :foreground ,blue-alt)))
    `(emms-playlist-selected-face ((,c :inherit bold :foreground ,blue-alt-other)))
...
;;;;; erc
    `(erc-action-face ((,c :foreground ,cyan-alt-other)))
    `(erc-bold-face ((,c :inherit bold)))
    `(erc-button ((,c :inherit button)))
    `(erc-command-indicator-face ((,c :inherit bold :foreground ,cyan-alt)))
    `(erc-current-nick-face ((,c :inherit bold :foreground ,red-alt)))
    ...
    `(erc-header-line ((,c :background ,bg-header :foreground ,fg-header)))
    `(erc-input-face ((,c :foreground ,magenta)))
    `(erc-inverse-face ((,c :inherit erc-default-face :inverse-video t)))
    `(erc-keyword-face ((,c :inherit bold :foreground ,magenta-alt-other)))
    ...
    `(erc-pal-face ((,c :inherit bold :foreground ,magenta-alt)))
    ...
    `(fg:erc-color-face11 ((,c :foreground ,cyan-alt-other)))
    `(fg:erc-color-face12 ((,c :foreground ,blue)))
    `(fg:erc-color-face13 ((,c :foreground ,magenta-alt)))
    `(fg:erc-color-face14 ((,c :foreground "gray60")))
    `(fg:erc-color-face15 ((,c :foreground "gray80")))
    `(fg:erc-color-face2 ((,c :foreground ,blue-alt-other)))
    `(fg:erc-color-face3 ((,c :foreground ,green)))
    `(fg:erc-color-face4 ((,c :foreground ,red)))
    `(fg:erc-color-face5 ((,c :foreground ,red-alt)))
    `(fg:erc-color-face6 ((,c :foreground ,magenta-alt-other)))
    `(fg:erc-color-face7 ((,c :foreground ,yellow-alt-other)))
    `(fg:erc-color-face8 ((,c :foreground ,yellow-alt)))
    `(fg:erc-color-face9 ((,c :foreground ,green-alt-other)))
;;;;; eros
...
;;;;; eshell
    `(eshell-ls-archive ((,c :foreground ,cyan-alt)))
    `(eshell-ls-backup ((,c :inherit shadow)))
    `(eshell-ls-clutter ((,c :foreground ,red-alt)))
    `(eshell-ls-directory ((,c :foreground ,blue-alt)))
    `(eshell-ls-executable ((,c :foreground ,magenta-alt)))
...
;;;;; eshell-git-prompt
    `(eshell-git-prompt-add-face ((,c :foreground ,magenta-alt-other)))
    `(eshell-git-prompt-branch-face ((,c :foreground ,magenta-alt)))
    ...
    `(eshell-git-prompt-robyrussell-branch-face ((,c :foreground ,magenta-alt)))
    `(eshell-git-prompt-robyrussell-git-dirty-face ((,c :foreground ,yellow)))
    `(eshell-git-prompt-robyrussell-git-face ((,c :foreground ,magenta-alt-other)))
;;;;; eshell-prompt-extras (epe)
    `(epe-dir-face ((,c :inherit bold :foreground ,blue)))
    `(epe-git-dir-face ((,c :foreground ,red-alt-other)))
    `(epe-git-face ((,c :foreground ,magenta-alt)))
    ...
    `(epe-pipeline-user-face ((,c :foreground ,magenta-alt-other)))
    `(epe-remote-face ((,c :inherit (shadow modus-themes-slant))))
    `(epe-status-face ((,c :foreground ,magenta-alt-other)))
...
;;;;; evil-mode
    `(evil-ex-commands ((,c :foreground ,magenta-alt-other)))
    `(evil-ex-info ((,c :foreground ,cyan-alt-other)))
...
;;;;; flycheck
    ...
    `(flycheck-error-list-id ((,c :foreground ,magenta-alt-other)))
...
;;;;; focus
    `(focus-unfocused ((,c :foreground ,fg-unfocused)))
;;;;; fold-this
...
;;;;; fountain-mode
    `(fountain-character ((,c :foreground ,blue-alt-other)))
    `(fountain-comment ((,c :inherit font-lock-comment-face)))
    `(fountain-dialog ((,c :foreground ,blue-alt)))
    `(fountain-metadata-key ((,c :foreground ,green-alt-other)))
    ...
    `(fountain-page-break ((,c :inherit bold :foreground ,red-alt)))
    `(fountain-page-number ((,c :inherit bold :foreground ,red-alt-other)))
    ...
    `(fountain-synopsis ((,c :foreground ,cyan-alt)))
    `(fountain-trans ((,c :foreground ,yellow-alt-other)))
;;;;; geiser
    `(geiser-font-lock-autodoc-current-arg ((,c :inherit bold
                                                    :background ,yellow-nuanced-bg
                                                    :foreground ,yellow-alt-other)))
    `(geiser-font-lock-autodoc-identifier ((,c :foreground ,cyan)))
    `(geiser-font-lock-doc-button ((,c :inherit button :foreground ,fg-docstring)))
    `(geiser-font-lock-doc-link ((,c :inherit button)))
    `(geiser-font-lock-error-link ((,c :inherit button :foreground ,red)))
    `(geiser-font-lock-image-button ((,c :inherit button :foreground ,green-alt)))
...
;;;;; git-commit
    ...
    `(git-commit-comment-branch-local ((,c :inherit font-lock-comment-face :foreground ,blue-alt)))
    `(git-commit-comment-branch-remote ((,c :inherit font-lock-comment-face :foreground ,magenta-alt)))
    `(git-commit-comment-detached ((,c :inherit font-lock-comment-face :foreground ,cyan-alt)))
    ...
    `(git-commit-known-pseudo-header ((,c :foreground ,cyan-alt-other)))
...
;;;;; git-rebase
    ...
    `(git-rebase-hash ((,c :foreground ,cyan-alt-other)))
;;;;; git-timemachine
    ...
    `(git-timemachine-minibuffer-detail-face ((,c :foreground ,red-alt)))
;;;;; gnus
    ...
    `(gnus-group-mail-1 ((,c :inherit bold :foreground ,magenta-alt)))
    `(gnus-group-mail-1-empty ((,c :foreground ,magenta-alt)))
    `(gnus-group-mail-2 ((,c :inherit bold :foreground ,magenta)))
    `(gnus-group-mail-2-empty ((,c :foreground ,magenta)))
    `(gnus-group-mail-3 ((,c :inherit bold :foreground ,magenta-alt-other)))
    `(gnus-group-mail-3-empty ((,c :foreground ,magenta-alt-other)))
    ...
    `(gnus-group-news-6 ((,c :inherit bold :foreground ,fg-unfocused)))
    `(gnus-group-news-6-empty ((,c :foreground ,fg-unfocused)))
    ...
    `(gnus-server-cloud ((,c :inherit bold :foreground ,cyan-alt)))
    ...
    `(gnus-summary-high-ticked ((,c :inherit bold :foreground ,red-alt-other)))
    ...
    `(gnus-summary-normal-ticked ((,c :foreground ,red-alt-other)))
...
;;;;; gotest
    ...
    `(go-test--pointer-face ((,c :foreground ,magenta-alt-other)))
...
;;;;; helm
    ...
    `(helm-bookmark-addressbook ((,c :foreground ,green-alt)))
    ...
    `(helm-bookmark-info ((,c :foreground ,cyan-alt)))
    `(helm-bookmark-man ((,c :foreground ,yellow-alt)))
    `(helm-bookmark-w3m ((,c :foreground ,blue-alt)))
    ...
    `(helm-buffer-modified ((,c :foreground ,yellow-alt)))
    `(helm-buffer-not-saved ((,c :foreground ,red-alt)))
    ...
    `(helm-ff-dirs ((,c :inherit bold :foreground ,blue-alt-other)))
    ...
    `(helm-ff-executable ((,c :foreground ,magenta-alt)))
    ...
    `(helm-ff-socket ((,c :foreground ,red-alt-other)))
    `(helm-ff-suid ((,c :inherit modus-themes-special-warm)))
    `(helm-ff-symlink ((,c :inherit modus-themes-link-symlink)))
    `(helm-ff-truename ((,c :foreground ,blue-alt-other)))
    `(helm-fd-finish ((,c :inherit success)))
    `(helm-grep-cmd-line ((,c :foreground ,yellow-alt-other)))
    ...
    `(helm-history-remote ((,c :foreground ,red-alt-other)))
    ...
    `(helm-moccur-buffer ((,c :inherit button :foreground ,cyan-alt-other)))
    ...
    `(helm-ucs-char ((,c :foreground ,yellow-alt-other)))
...
;;;;; highlight region or ad-hoc regexp
    ...
    `(highlight-changes ((,c :foreground ,red-alt :underline nil)))
...
;;;;; highlight-numbers
    `(highlight-numbers-number ((,c :foreground ,blue-alt-other)))
;;;;; highlight-thing
    `(highlight-thing ((,c :inherit modus-themes-special-calm)))
;;;;; hl-defined
    `(hdefd-functions ((,c :foreground ,blue)))
    `(hdefd-undefined ((,c :foreground ,red-alt)))
    `(hdefd-variables ((,c :foreground ,cyan-alt)))
;;;;; hl-fill-column
    `(hl-fill-column-face ((,c :background ,bg-active :foreground ,fg-active)))
;;;;; hl-todo
    `(hl-todo ((,c :inherit (bold modus-themes-slant) :foreground ,red-alt-other)))
;;;;; hydra
    `(hydra-face-amaranth ((,c :inherit bold :foreground ,yellow-alt)))
    `(hydra-face-blue ((,c :inherit bold :foreground ,blue)))
    `(hydra-face-pink ((,c :inherit bold :foreground ,magenta-alt-faint)))
    `(hydra-face-red ((,c :inherit bold :foreground ,red-faint)))
    `(hydra-face-teal ((,c :inherit bold :foreground ,cyan-alt-other)))
;;;;; icomplete
...
;;;;; imenu-list
    ...
    `(imenu-list-entry-face-2 ((,c :foreground ,cyan-alt-other)))
    `(imenu-list-entry-face-3 ((,c :foreground ,blue-alt)))
    `(imenu-list-entry-subalist-face-0 ((,c :inherit bold :foreground ,magenta-alt-other :underline t)))
    `(imenu-list-entry-subalist-face-1 ((,c :inherit bold :foreground ,magenta :underline t)))
    `(imenu-list-entry-subalist-face-2 ((,c :inherit bold :foreground ,green-alt-other :underline t)))
    `(imenu-list-entry-subalist-face-3 ((,c :inherit bold :foreground ,red-alt-other :underline t)))
;;;;; indium
...
;;;;; interaction-log
    `(ilog-buffer-face ((,c :foreground ,magenta-alt-other)))
    `(ilog-change-face ((,c :foreground ,magenta-alt)))
    `(ilog-echo-face ((,c :foreground ,yellow-alt-other)))
...
;;;;; ivy
    ...
    `(ivy-org ((,c :foreground ,cyan-alt-other)))
    `(ivy-remote ((,c :foreground ,magenta)))
    `(ivy-separator ((,c :inherit shadow)))
    `(ivy-subdir ((,c :foreground ,blue)))
    `(ivy-virtual ((,c :foreground ,magenta-alt-other)))
;;;;; ivy-posframe
    `(ivy-posframe-border ((,c :background ,fg-window-divider-inner)))
...
;;;;; journalctl-mode
    ...
    `(journalctl-process-face ((,c :foreground ,cyan-alt-other)))
...
;;;;; jupyter
    ...
    `(jupyter-repl-input-prompt ((,c :foreground ,cyan-alt-other)))
    `(jupyter-repl-output-prompt ((,c :foreground ,magenta-alt-other)))
...
;;;;; ledger-mode
    ...
    `(ledger-font-directive-face ((,c :foreground ,magenta-alt-other)))
    `(ledger-font-posting-date-face ((,c :inherit bold :foreground ,fg-main)))
    `(ledger-font-periodic-xact-face ((,c :foreground ,cyan-alt-other)))
    `(ledger-font-posting-amount-face ((,c :foreground ,fg-special-mild)))
    `(ledger-font-payee-cleared-face ((,c :foreground ,blue-alt)))
    `(ledger-font-payee-pending-face ((,c :foreground ,yellow)))
    `(ledger-font-payee-uncleared-face ((,c :foreground ,red-alt-other)))
    `(ledger-font-xact-highlight-face ((,c :background ,bg-hl-alt)))
;;;;; leerzeichen
    `(leerzeichen ((,c :background ,bg-whitespace :foreground ,fg-whitespace)))
...
;;;;; lsp-mode
    ...
    `(lsp-face-semhl-constant ((,c :foreground ,blue-alt-other)))
    `(lsp-face-semhl-deprecated ((,c :inherit modus-themes-lang-warning)))
    `(lsp-face-semhl-enummember ((,c :foreground ,blue-alt-other)))
    `(lsp-face-semhl-field ((,c :foreground ,cyan-alt)))
    `(lsp-face-semhl-field-static ((,c :inherit modus-themes-slant :foreground ,cyan-alt)))
    `(lsp-face-semhl-function ((,c :foreground ,magenta)))
    `(lsp-face-semhl-method ((,c :foreground ,magenta)))
    `(lsp-face-semhl-namespace ((,c :inherit modus-themes-bold :foreground ,magenta-alt)))
    `(lsp-face-semhl-preprocessor ((,c :foreground ,red-alt-other)))
    `(lsp-face-semhl-static-method ((,c :inherit modus-themes-slant :foreground ,magenta)))
    `(lsp-face-semhl-type-class ((,c :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-enum ((,c :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-primitive ((,c :inherit modus-themes-slant :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-template ((,c :inherit modus-themes-slant :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-typedef ((,c :inherit modus-themes-slant :foreground ,magenta-alt)))
    `(lsp-face-semhl-variable ((,c :foreground ,cyan)))
    `(lsp-face-semhl-variable-local ((,c :foreground ,cyan)))
    `(lsp-face-semhl-variable-parameter ((,c :foreground ,cyan-alt-other)))
    `(lsp-lens-face ((,c  :inherit shadow :height 0.8)))
    `(lsp-lens-mouse-face ((,c :height 0.8 :foreground ,blue-alt-other :underline t)))
    `(lsp-ui-doc-background ((,c :background ,bg-alt)))
    `(lsp-ui-doc-header ((,c :background ,bg-header :foreground ,fg-header)))
    `(lsp-ui-doc-url ((,c :inherit button)))
    `(lsp-ui-peek-filename ((,c :foreground ,fg-special-warm)))
    `(lsp-ui-peek-footer ((,c :background ,bg-header :foreground ,fg-header)))
    `(lsp-ui-peek-header ((,c :background ,bg-header :foreground ,fg-header)))
...
;;;;; macrostep
    ...
    `(macrostep-macro-face ((,c :inherit button :foreground ,green-alt)))
;;;;; magit
    ...
    `(magit-blame-name ((,c :foreground ,magenta-alt-other)))
    `(magit-blame-summary ((,c :foreground ,cyan-alt-other)))
    ...
    `(magit-branch-local ((,c :foreground ,blue-alt)))
    `(magit-branch-remote ((,c :foreground ,magenta-alt)))
    `(magit-branch-remote-head ((,c :foreground ,magenta-alt-other :box t)))
    ...
    `(magit-diff-context ((,c ,@(unless (eq modus-themes-diffs 'bg-only) (list :foreground fg-unfocused)))))
    ...
    `(magit-dimmed ((,c :foreground ,fg-unfocused)))
    ...
    `(magit-keyword-squash ((,c :inherit bold :foreground ,yellow-alt-other)))
    `(magit-log-author ((,c :foreground ,cyan)))
    `(magit-log-date ((,c :inherit shadow)))
    `(magit-log-graph ((,c :foreground ,fg-dim)))
    `(magit-mode-line-process ((,c :inherit bold :foreground ,cyan-active)))
    `(magit-mode-line-process-error ((,c :inherit bold :foreground ,red-active)))
    `(magit-process-ng ((,c :inherit error)))
    `(magit-process-ok ((,c :inherit success)))
    `(magit-reflog-amend ((,c :inherit warning)))
    `(magit-reflog-checkout ((,c :inherit bold :foreground ,blue-alt)))
    ...
    `(magit-reflog-remote ((,c :inherit bold :foreground ,magenta-alt-other)))
    ...
    `(magit-sequence-exec ((,c :inherit bold :foreground ,magenta-alt)))
    `(magit-sequence-head ((,c :inherit bold :foreground ,cyan-alt)))
    ...
    `(magit-tag ((,c :foreground ,yellow-alt-other)))
;;;;; magit-imerge
    `(magit-imerge-overriding-value ((,c :inherit bold :foreground ,red-alt)))
;;;;; make-mode (makefiles)
    `(makefile-makepp-perl ((,c :background ,cyan-nuanced-bg)))
    `(makefile-space ((,c :background ,magenta-nuanced-bg)))
;;;;; man
    `(Man-overstrike ((,c :inherit bold :foreground ,magenta-alt)))
    `(Man-reverse ((,c :inherit modus-themes-subtle-magenta)))
    `(Man-underline ((,c :foreground ,cyan-alt-other :underline t)))
;;;;; marginalia
    `(marginalia-archive ((,c :foreground ,cyan-alt-other)))
    `(marginalia-char ((,c :foreground ,magenta)))
    `(marginalia-date ((,c :foreground ,cyan)))
    `(marginalia-documentation ((,c :inherit modus-themes-slant :foreground ,fg-docstring)))
    `(marginalia-file-name ((,c :foreground ,blue-faint)))
    `(marginalia-file-owner ((,c :foreground ,red-faint)))
    `(marginalia-file-priv-dir ((,c :foreground ,blue-alt)))
    `(marginalia-file-priv-exec ((,c :foreground ,magenta-alt)))
    `(marginalia-file-priv-link ((,c :foreground ,blue-alt-other)))
    ...
    `(marginalia-function ((,c :foreground ,magenta-alt-faint)))
    `(marginalia-key ((,c :inherit modus-themes-key-binding)))
    `(marginalia-lighter ((,c :foreground ,blue-alt)))
    `(marginalia-list ((,c :foreground ,magenta-alt-other-faint)))
    `(marginalia-mode ((,c :foreground ,cyan)))
    `(marginalia-modified ((,c :foreground ,magenta-alt-faint)))
    `(marginalia-null ((,c :inherit shadow)))
    `(marginalia-number ((,c :foreground ,cyan)))
    `(marginalia-size ((,c :foreground ,cyan-alt-other-faint)))
    `(marginalia-string ((,c :foreground ,blue-alt)))
    `(marginalia-symbol ((,c :foreground ,blue-alt-other-faint)))
    `(marginalia-true ((,c :foreground ,fg-main)))
    `(marginalia-type ((,c :foreground ,cyan-alt-other)))
...
;;;;; markdown-mode
    ...
    `(markdown-footnote-marker-face ((,c :inherit bold :foreground ,cyan-alt)))
    `(markdown-footnote-text-face ((,c :inherit modus-themes-slant :foreground ,fg-main)))
    `(markdown-gfm-checkbox-face ((,c :foreground ,yellow-alt-other)))
    ...
    `(markdown-math-face ((,c :foreground ,magenta-alt-other)))
    `(markdown-metadata-key-face ((,c :foreground ,cyan-alt-other)))
    `(markdown-metadata-value-face ((,c :foreground ,blue-alt)))
    ...
    `(markdown-table-face ((,c :inherit modus-themes-fixed-pitch
                                   :foreground ,fg-special-cold)))
    `(markdown-url-face ((,c :foreground ,blue-alt)))
;;;;; markup-faces (`adoc-mode')
    ...
    `(markup-complex-replacement-face ((,c :background ,magenta-nuanced-bg :foreground ,magenta-alt-other)))
    `(markup-emphasis-face ((,c :inherit markup-italic-face)))
    `(markup-error-face ((,c :inherit error)))
    `(markup-gen-face ((,c :foreground ,magenta-alt)))
    ...
    `(markup-reference-face ((,c :inherit modus-themes-slant :foreground ,blue-alt)))
    `(markup-replacement-face ((,c :inherit modus-themes-fixed-pitch :foreground ,red-alt)))
    `(markup-secondary-text-face ((,c :height 0.9 :foreground ,cyan-alt-other)))
    `(markup-small-face ((,c :inherit markup-gen-face :height 0.9)))
    `(markup-strong-face ((,c :inherit markup-bold-face)))
    `(markup-subscript-face ((,c :height 0.9 :foreground ,magenta-alt-other)))
    `(markup-superscript-face ((,c :height 0.9 :foreground ,magenta-alt-other)))
...
;;;;; mentor
    ...
    `(mentor-download-progress ((,c :foreground ,blue-alt-other)))
    `(mentor-download-size ((,c :foreground ,magenta-alt-other)))
    `(mentor-download-speed-down ((,c :foreground ,cyan-alt)))
    `(mentor-download-speed-up ((,c :foreground ,red-alt)))
    `(mentor-download-state ((,c :foreground ,yellow-alt)))
    `(mentor-highlight-face ((,c :inherit modus-themes-subtle-blue)))
    `(mentor-tracker-name ((,c :foreground ,magenta-alt)))
;;;;; messages
    `(message-cited-text-1 ((,c ,@(modus-themes--mail-cite blue-faint blue fg-special-cold))))
    `(message-cited-text-2 ((,c ,@(modus-themes--mail-cite yellow-faint yellow yellow-alt-faint))))
    `(message-cited-text-3 ((,c ,@(modus-themes--mail-cite magenta-alt-faint magenta-alt fg-special-calm))))
    `(message-cited-text-4 ((,c ,@(modus-themes--mail-cite cyan-alt-other-faint cyan-alt-other fg-special-mild))))
    `(message-header-cc ((,c :foreground ,blue-alt-other)))
    `(message-header-name ((,c :inherit bold :foreground ,cyan)))
    `(message-header-newsgroups ((,c :inherit message-header-other)))
    `(message-header-other ((,c :foreground ,fg-special-calm)))
    `(message-header-subject ((,c :inherit bold :foreground ,magenta-alt)))
    `(message-header-to ((,c :inherit bold :foreground ,magenta-alt-other)))
    `(message-header-xheader ((,c :foreground ,blue-alt)))
    `(message-mml ((,c :foreground ,cyan-alt-other)))
    `(message-separator ((,c :inherit modus-themes-intense-neutral)))
;;;;; mini-modeline
    `(mini-modeline-mode-line ((,c :background ,blue-intense :height 0.14)))
    `(mini-modeline-mode-line-inactive ((,c :background ,fg-window-divider-inner :height 0.1)))
;;;;; minimap
...
;;;;; mpdel
    ...
    `(mpdel-playlist-current-song-face ((,c :inherit bold :foreground ,blue-alt-other)))
;;;;; mu4e
    ...
    `(mu4e-draft-face ((,c :foreground ,magenta-alt)))
    `(mu4e-flagged-face ((,c :foreground ,red-alt-other)))
    `(mu4e-footer-face ((,c :inherit modus-themes-slant :foreground ,fg-special-cold)))
    `(mu4e-forwarded-face ((,c :foreground ,magenta-alt-other)))
    ...
    `(mu4e-system-face ((,c :inherit modus-themes-slant :foreground ,fg-mark-del)))
...
;;;;; neotree
    ...
    `(neo-root-dir-face ((,c :inherit bold :foreground ,cyan-alt)))
    ...
    `(neo-vc-missing-face ((,c :foreground ,red-alt)))
    `(neo-vc-needs-merge-face ((,c :foreground ,magenta-alt)))
...
;;;;; notmuch
    ...
    `(notmuch-crypto-part-header ((,c :foreground ,magenta-alt-other)))
    ...
    `(notmuch-search-flagged-face ((,c :foreground ,red-alt-other)))
    ...
    `(notmuch-tag-flagged ((,c :foreground ,red-alt)))
    `(notmuch-tag-unread ((,c :foreground ,magenta-alt)))
...
;;;;; org
    `(org-agenda-calendar-event ((,c ,@(modus-themes--agenda-event blue-alt))))
    `(org-agenda-calendar-sexp ((,c ,@(modus-themes--agenda-event blue-alt t))))
    `(org-agenda-clocking ((,c :background ,yellow-nuanced-bg :foreground ,red-alt)))
    `(org-agenda-column-dateline ((,c :background ,bg-alt)))
    `(org-agenda-current-time ((,c :foreground ,blue-alt-other-faint)))
    ...
    `(org-agenda-date-weekend
      ((,c ,@(modus-themes--agenda-date cyan-alt-other-faint fg-alt cyan fg-main))))
    `(org-agenda-date-weekend-today
      ((,c ,@(modus-themes--agenda-date cyan-alt-other-faint fg-alt cyan fg-main bg-special-cold t t))))
    ...
    `(org-agenda-structure ((,c ,@(modus-themes--agenda-structure blue-alt))))
    ...
    `(org-checkbox ((,c :foreground ,yellow-alt-other)))
    `(org-checkbox-statistics-done ((,c :inherit org-done)))
    `(org-checkbox-statistics-todo ((,c :inherit org-todo)))
    `(org-clock-overlay ((,c :background ,yellow-nuanced-bg :foreground ,red-alt-faint)))
    ...
    `(org-date-selected ((,c :foreground ,blue-alt :inverse-video t)))
    ...
    `(org-footnote ((,c :inherit button
                            ,@(modus-themes--link-color
                               blue-alt blue-alt-faint))))
    `(org-formula ((,c :inherit modus-themes-fixed-pitch :foreground ,red-alt)))
    ...
    `(org-scheduled ((,c ,@(modus-themes--agenda-scheduled yellow-faint fg-special-warm magenta-alt))))
    `(org-scheduled-previously ((,c ,@(modus-themes--agenda-scheduled yellow fg-special-warm yellow-alt-other))))
    `(org-scheduled-today ((,c ,@(modus-themes--agenda-scheduled yellow fg-special-warm magenta-alt-other))))
    `(org-sexp-date ((,c :foreground ,cyan-alt-other)))
    ...
    `(org-upcoming-deadline ((,c :foreground ,red-alt-other)))
    ...
    `(org-warning ((,c :inherit bold :foreground ,red-alt-other)))
;;;;; org-journal
    `(org-journal-calendar-entry-face ((,c :inherit modus-themes-slant :foreground ,yellow-alt-other)))
    `(org-journal-calendar-scheduled-face ((,c :inherit modus-themes-slant :foreground ,red-alt-other)))
    `(org-journal-highlight ((,c :foreground ,magenta-alt)))
;;;;; org-noter
...
;;;;; org-superstar
    ...
    `(org-superstar-leading ((,c :foreground ,fg-whitespace)))
...
;;;;; package (M-x list-packages)
    ...
    `(package-status-available ((,c :foreground ,cyan-alt-other)))
    `(package-status-avail-obso ((,c :inherit error)))
    `(package-status-built-in ((,c :foreground ,magenta)))
    `(package-status-dependency ((,c :foreground ,magenta-alt-other)))
    `(package-status-disabled ((,c :inherit modus-themes-subtle-red)))
    `(package-status-external ((,c :foreground ,cyan-alt-other)))
    `(package-status-held ((,c :foreground ,yellow-alt)))
...
;;;;; page-break-lines
    `(page-break-lines ((,c :inherit default :foreground ,fg-window-divider-outer)))
;;;;; pandoc-mode
    `(pandoc-citation-key-face ((,c :background ,bg-dim :foreground ,magenta-alt)))
    `(pandoc-directive-@@-face ((,c :background ,bg-dim :foreground ,blue-alt-other)))
    `(pandoc-directive-braces-face ((,c :foreground ,blue-alt-other)))
    `(pandoc-directive-contents-face ((,c :foreground ,cyan-alt-other)))
    `(pandoc-directive-type-face ((,c :foreground ,magenta)))
;;;;; paren-face
    `(parenthesis ((,c :foreground ,fg-unfocused)))
;;;;; pass
...
;;;;; pomidor
    `(pomidor-break-face ((,c :foreground ,blue-alt-other)))
    `(pomidor-overwork-face ((,c :foreground ,red-alt-other)))
...
;;;;; powerline
    `(powerline-active0 ((,c :background ,fg-unfocused :foreground ,bg-main)))
...
;;;;; quick-peek
    ...
    `(quick-peek-border-face ((,c :background ,fg-window-divider-inner :height 1)))
...
;;;;; racket-mode
    ...
    `(racket-debug-result-face ((,c :inherit bold :box (:line-width -1 :color nil)
                                        :foreground ,green)))
    `(racket-here-string-face ((,c :foreground ,blue-alt)))
    `(racket-keyword-argument-face ((,c :foreground ,red-alt)))
    `(racket-logger-config-face ((,c :inherit (shadow modus-themes-slant))))
    `(racket-logger-debug-face ((,c :foreground ,blue-alt-other)))
    `(racket-logger-info-face ((,c :foreground ,fg-lang-note)))
    `(racket-logger-topic-face ((,c :inherit modus-themes-slant :foreground ,magenta)))
    `(racket-selfeval-face ((,c :foreground ,green-alt)))
    `(racket-xp-error-face ((,c :inherit modus-themes-lang-error)))
;;;;; rainbow-blocks
    `(rainbow-blocks-depth-1-face ((,c :foreground ,magenta-alt-other)))
    `(rainbow-blocks-depth-2-face ((,c :foreground ,blue)))
    `(rainbow-blocks-depth-3-face ((,c :foreground ,magenta-alt)))
    `(rainbow-blocks-depth-4-face ((,c :foreground ,green)))
    `(rainbow-blocks-depth-5-face ((,c :foreground ,magenta)))
    `(rainbow-blocks-depth-6-face ((,c :foreground ,cyan)))
    `(rainbow-blocks-depth-7-face ((,c :foreground ,yellow)))
    `(rainbow-blocks-depth-8-face ((,c :foreground ,cyan-alt)))
    `(rainbow-blocks-depth-9-face ((,c :foreground ,red-alt)))
...
;;;;; rcirc
    ...
    `(rcirc-nick-in-message ((,c :inherit bold :foreground ,red-alt)))
    `(rcirc-nick-in-message-full-line ((,c :inherit bold :foreground ,cyan-alt-other)))
...
;;;;; rg (rg.el)
    `(rg-column-number-face ((,c :foreground ,magenta-alt-other)))
    `(rg-context-face ((,c :foreground ,fg-unfocused)))
    ...
    `(rg-literal-face ((,c :foreground ,blue-alt)))
...
;;;;; rmail
    `(rmail-header-name ((,c :foreground ,cyan-alt-other)))
    `(rmail-highlight ((,c :inherit bold :foreground ,magenta-alt)))
;;;;; ruler-mode
    ...
    `(ruler-mode-default ((,c :inherit default :background ,bg-alt :foreground ,fg-unfocused)))
...
;;;;; semantic
    ...
    `(semantic-unmatched-syntax-face ((,c :underline ,fg-lang-error)))
;;;;; sesman
    ...
    `(sesman-project-face ((,c :inherit bold :foreground ,magenta-alt-other)))
;;;;; shell-script-mode
    `(sh-heredoc ((,c :foreground ,blue-alt)))
    `(sh-quoted-exec ((,c :inherit modus-themes-bold :foreground ,magenta-alt)))
;;;;; shortdoc
...
;;;;; speedbar
    ...
    `(speedbar-tag-face ((,c :foreground ,yellow-alt-other)))
;;;;; spell-fu
    `(spell-fu-incorrect-face ((,c :inherit modus-themes-lang-error)))
;;;;; stripes
    `(stripes ((,c :background ,bg-alt)))
;;;;; suggest
    `(suggest-heading ((,c :inherit bold :foreground ,yellow-alt-other)))
;;;;; switch-window
...
;;;;; swiper
    ...
    `(swiper-line-face ((,c :background ,bg-hl-alt-intense)))
    `(swiper-match-face-1 (( )))
...
;;;;; sx
    `(sx-inbox-item-type ((,c :foreground ,magenta-alt-other)))
    ...
    `(sx-tag ((,c :foreground ,magenta-alt)))
    `(sx-user-name ((,c :foreground ,blue-alt)))
...
;;;;; syslog-mode
    `(syslog-debug ((,c :inherit bold :foreground ,cyan-alt-other)))
    ...
    `(syslog-hour ((,c :inherit bold :foreground ,magenta-alt-other)))
    `(syslog-info ((,c :inherit success)))
    `(syslog-ip ((,c :inherit bold :foreground ,fg-special-mild :underline t)))
    `(syslog-su ((,c :inherit bold :foreground ,red-alt)))
...
;;;;; tab-line-mode
    ...
    `(tab-line-tab-modified ((,c :foreground ,red-alt-other-faint)))
...
;;;;; telega
    ...
    `(telega-secret-title ((,c :foreground ,magenta-alt)))
    `(telega-unmuted-count ((,c :foreground ,blue-alt-other)))
    `(telega-user-online-status ((,c :foreground ,cyan-active)))
    `(telega-username ((,c :foreground ,cyan-alt-other)))
...
;;;;; transient
    ...
    `(transient-amaranth ((,c :inherit bold :foreground ,yellow-alt)))
    ...
    `(transient-pink ((,c :inherit bold :foreground ,magenta-alt-faint)))
    `(transient-purple ((,c :inherit bold :foreground ,magenta-alt-other)))
    `(transient-red ((,c :inherit bold :foreground ,red-faint)))
    `(transient-teal ((,c :inherit bold :foreground ,cyan-alt-other)))
    `(transient-unreachable ((,c :inherit shadow)))
    `(transient-unreachable-key ((,c :inherit shadow)))
    `(transient-value ((,c :inherit bold :background ,yellow-nuanced-bg :foreground ,yellow-alt-other)))
;;;;; trashed
...
;;;;; treemacs
    `(treemacs-directory-collapsed-face ((,c :foreground ,magenta-alt)))
    ...
    `(treemacs-help-column-face ((,c :inherit modus-themes-bold :foreground ,magenta-alt-other :underline t)))
    `(treemacs-help-title-face ((,c :foreground ,blue-alt-other)))
    ...
    `(treemacs-root-face ((,c :inherit bold :foreground ,blue-alt-other :height 1.2 :underline t)))
    ...
    `(treemacs-tags-face ((,c :foreground ,blue-alt)))
;;;;; tty-menu
...
;;;;; vc (vc-dir.el, vc-hooks.el)
    `(vc-dir-directory ((,c :foreground ,blue)))
    `(vc-dir-file ((,c :foreground ,fg-main)))
    `(vc-dir-header ((,c :foreground ,cyan-alt-other)))
    `(vc-dir-header-value ((,c :foreground ,magenta-alt-other)))
    `(vc-dir-mark-indicator ((,c :foreground ,blue-alt-other)))
    `(vc-dir-status-edited ((,c :foreground ,yellow)))
    `(vc-dir-status-ignored ((,c :inherit shadow)))
    `(vc-dir-status-up-to-date ((,c :foreground ,cyan)))
    `(vc-dir-status-warning ((,c :inherit error)))
    `(vc-conflict-state ((,c :inherit bold :foreground ,red-active)))
    `(vc-edited-state ((,c :foreground ,yellow-active)))
    `(vc-locally-added-state ((,c :foreground ,cyan-active)))
    `(vc-locked-state ((,c :foreground ,blue-active)))
    `(vc-missing-state ((,c :inherit modus-themes-slant :foreground ,magenta-active)))
    `(vc-needs-update-state ((,c :inherit modus-themes-slant :foreground ,green-active)))
    `(vc-removed-state ((,c :foreground ,red-active)))
    `(vc-state-base ((,c :foreground ,fg-active)))
    `(vc-up-to-date-state ((,c :foreground ,fg-special-cold)))
;;;;; vertico
...
;;;;; vimish-fold
    `(vimish-fold-fringe ((,c :foreground ,cyan-active)))
...
;;;;; web-mode
    ...
    `(web-mode-whitespace-face ((,c :background ,bg-whitespace :foreground ,fg-whitespace)))
;;;;; wgrep
...
;;;;; which-key
    ...
    `(which-key-group-description-face ((,c :foreground ,magenta-alt)))
    ...
    `(which-key-special-key-face ((,c :inherit bold :foreground ,red-alt)))
;;;;; whitespace-mode
    `(whitespace-big-indent ((,c :inherit modus-themes-subtle-red)))
    `(whitespace-empty ((,c :inherit modus-themes-intense-magenta)))
    `(whitespace-hspace ((,c :background ,bg-whitespace :foreground ,fg-whitespace)))
    `(whitespace-indentation ((,c :background ,bg-whitespace :foreground ,fg-whitespace)))
    `(whitespace-line ((,c :inherit modus-themes-subtle-yellow)))
    `(whitespace-newline ((,c :background ,bg-whitespace :foreground ,fg-whitespace)))
    `(whitespace-space ((,c :background ,bg-whitespace :foreground ,fg-whitespace)))
    ...
    `(whitespace-tab ((,c :background ,bg-whitespace :foreground ,fg-whitespace)))
    `(whitespace-trailing ((,c :inherit modus-themes-intense-red)))
;;;;; window-divider-mode
    `(window-divider ((,c :foreground ,fg-window-divider-inner)))
...
;;;;; writegood-mode
    `(writegood-duplicates-face ((,c :background ,bg-alt :foreground ,red-alt :underline t)))
    `(writegood-passive-voice-face ((,c :inherit modus-themes-lang-warning)))
    `(writegood-weasels-face ((,c :inherit modus-themes-lang-error)))
;;;;; woman
    `(woman-addition ((,c :foreground ,magenta-alt-other)))
    `(woman-bold ((,c :inherit bold :foreground ,magenta-alt)))
    `(woman-italic ((,c :inherit italic :foreground ,cyan)))
    `(woman-unknown ((,c :foreground ,green-alt)))
;;;;; xah-elisp-mode
...
;;;;; yasnippet
    `(yas-field-highlight-face ((,c :background ,bg-hl-alt-intense)))
;;;;; ztree
