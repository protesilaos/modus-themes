...
;;;;; completion frameworks
    ...
    `(modus-themes-completion-match-2 ((,c ,@(modus-themes--completion-match fg-accent-2 bg-accent-2))))
    `(modus-themes-completion-match-3 ((,c ,@(modus-themes--completion-match fg-accent-3 bg-accent-3))))
...
;;;;; basic and/or ungrouped styles
    ...
    `(edmacro-label ((,c :inherit bold :foreground ,fg-accent-0)))
...
;;;;; bongo
    `(bongo-album-title (( )))
    `(bongo-artist ((,c :foreground ,fg-accent-0)))
    ...
    `(bongo-track-title ((,c :foreground ,fg-accent-1)))
...
;;;;; dired
    ...
    `(dired-directory ((,c :foreground ,fg-accent-0)))
...
;;;;; dired-git
    `(dired-git-branch-else ((,c :inherit bold :foreground ,fg-accent-0)))
    `(dired-git-branch-master ((,c :inherit bold :foreground ,fg-accent-1)))
;;;;; dired-git-info
...
;;;;; diredfl
    ...
    `(diredfl-exec-priv ((,c :foreground ,fg-accent-1)))
    ...
    `(diredfl-other-priv ((,c :foreground ,fg-accent-2)))
    `(diredfl-rare-priv ((,c :foreground ,fg-accent-3)))
    ...
    `(diredfl-write-priv ((,c :foreground ,fg-accent-0)))
...
;;;;; ement (ement.el)
    ...
    `(ement-room-self ((,c :inherit bold :foreground ,fg-accent-1)))
    ...
    `(ement-room-user ((,c :inherit bold :foreground ,fg-accent-0)))
;;;;; emms
...
;;;;; erc
    `(erc-action-face ((,c :foreground ,fg-accent-2)))
    `(erc-bold-face ((,c :inherit bold)))
    `(erc-button ((,c :inherit button)))
    `(erc-command-indicator-face ((,c :inherit bold :foreground ,fg-accent-3)))
    ...
    `(erc-nick-default-face ((,c :inherit bold :foreground ,fg-accent-0)))
    ...
    `(erc-pal-face ((,c :inherit bold :foreground ,fg-accent-1)))
...
;;;;; eshell
    `(eshell-ls-archive ((,c :foreground ,fg-accent-2)))
    `(eshell-ls-backup ((,c :inherit shadow)))
    `(eshell-ls-clutter ((,c :inherit shadow)))
    `(eshell-ls-directory ((,c :foreground ,fg-accent-0)))
    `(eshell-ls-executable ((,c :foreground ,fg-accent-1)))
    `(eshell-ls-missing ((,c :inherit error)))
    `(eshell-ls-product ((,c :inherit shadow)))
    `(eshell-ls-readonly ((,c :foreground ,warning)))
    `(eshell-ls-special ((,c :foreground ,fg-accent-3)))
...
;;;;; git-commit
    ...
    `(git-commit-comment-branch-local ((,c :inherit font-lock-comment-face :foreground ,fg-accent-0)))
    `(git-commit-comment-branch-remote ((,c :inherit font-lock-comment-face :foreground ,fg-accent-1)))
...
;;;;; gotest
    ...
    `(go-test--pointer-face ((,c :foreground ,fg-accent-0)))
...
;;;;; ido-mode
    ...
    `(ido-subdir ((,c :foreground ,fg-accent-0)))
    `(ido-virtual ((,c :foreground ,fg-accent-1)))
;;;;; iedit
...
;;;;; ivy
    ...
    `(ivy-subdir ((,c :foreground ,fg-accent-0)))
    `(ivy-virtual ((,c :foreground ,fg-accent-1)))
;;;;; ivy-posframe
...
;;;;; magit
    ...
    `(magit-blame-name (( )))
    `(magit-blame-summary ((  )))
    `(magit-branch-local ((,c :foreground ,fg-accent-0)))
    `(magit-branch-remote ((,c :foreground ,fg-accent-1)))
    ...
    `(magit-diff-file-heading ((,c :inherit bold :foreground ,fg-accent-0)))
    ...
    `(magit-filename ((,c :foreground ,fg-accent-2)))
    ...
    `(magit-tag ((,c :foreground ,fg-accent-3))) ; compare with branches
;;;;; make-mode (makefiles)
    `(makefile-makepp-perl ((,c :background ,bg-dim)))
    `(makefile-space ((,c :background ,bg-inactive)))
;;;;; man
    `(Man-overstrike ((,c :inherit bold :foreground ,fg-accent-0)))
    `(Man-underline ((,c :foreground ,fg-accent-1 :underline t)))
;;;;; marginalia
    `(marginalia-archive ((,c :foreground ,fg-accent-0)))
    `(marginalia-char ((,c :foreground ,fg-accent-2)))
    ...
    `(marginalia-file-priv-dir ((,c :foreground ,fg-accent-0)))
    `(marginalia-file-priv-exec ((,c :foreground ,fg-accent-1)))
    `(marginalia-file-priv-link ((,c :foreground ,fg-link)))
    `(marginalia-file-priv-no ((,c :inherit shadow)))
    `(marginalia-file-priv-other ((,c :foreground ,fg-accent-2)))
    `(marginalia-file-priv-rare ((,c :foreground ,fg-accent-3)))
    `(marginalia-file-priv-read ((,c :foreground ,fg-main)))
    `(marginalia-file-priv-write ((,c :foreground ,fg-accent-0)))
...
;;;;; mpdel
    `(mpdel-browser-directory-face ((,c :foreground ,fg-accent-0)))
    `(mpdel-playlist-current-song-face ((,c :inherit bold :foreground ,fg-accent-0)))
;;;;; mu4e
...
;;;;; neotree
    `(neo-banner-face ((,c :foreground ,fg-accent-0)))
    `(neo-button-face ((,c :inherit button)))
    `(neo-dir-link-face (( )))
    `(neo-expand-btn-face (( )))
    `(neo-file-link-face (( )))
    `(neo-header-face ((,c :inherit bold)))
    `(neo-root-dir-face ((,c :inherit bold :foreground ,fg-accent-0)))
...
;;;;; notmuch
    ...
    `(notmuch-tag-face ((,c :foreground ,fg-accent-0)))
    `(notmuch-tag-flagged ((,c :foreground ,err)))
    `(notmuch-tag-unread ((,c :foreground ,fg-accent-1)))
...
;;;;; pass
    `(pass-mode-directory-face ((,c :inherit bold :foreground ,fg-accent-0)))
...
;;;;; sesman
    ...
    `(sesman-buffer-face ((,c :foreground ,fg-accent-1)))
    `(sesman-directory-face ((,c :inherit bold :foreground ,fg-accent-0)))
    `(sesman-project-face ((,c :inherit bold :foreground ,fg-accent-2)))
;;;;; shell-script-mode
...
;;;;; speedbar
    ...
    `(speedbar-directory-face ((,c :inherit bold :foreground ,fg-accent-0)))
    ...
    `(speedbar-tag-face ((,c :foreground ,fg-accent-1)))
;;;;; spell-fu
...
;;;;; trashed
    ...
    `(trashed-directory ((,c :foreground ,fg-accent-0)))
...
;;;;; woman
    `(woman-addition ((,c :foreground ,fg-accent-2)))
    `(woman-bold ((,c :inherit bold :foreground ,fg-accent-0)))
    `(woman-italic ((,c :inherit italic :foreground ,fg-accent-1)))
    `(woman-unknown ((,c :foreground ,fg-accent-3)))
;;;;; xah-elisp-mode
